class Streamlm < Formula
  ...
  resource "litellm" do
    url "https://files.pythonhosted.org/packages/c9/25/8253bbc904d69b61806fc76e6c9c11509b4270ac201eeff6e5f95a5f2d01/litellm-1.74.1.tar.gz"
    sha256 "0e0c83356c33885dce379cd86d38a728e870dbaaf43ae50e9d0153e29c207a85"
  end
  ...
  resource "md2term" do
    ...
    sha256 "159dbe2843fab9f6714d7e0f4b64dfd104b2c2c8722004f7b3edc2e02491ed5b"
  end
  ...
  resource "openai" do
    ...
    sha256 "54bc42df9f7142312647dd485d34cca5df20af825fa64a30ca55164be2cf4cc9"
  end
